...
class OInstantReportScreen extends StatefulWidget {
  const OInstantReportScreen({Key? key}) : super(key: key);

  @override
  _OInstantReportScreenState createState() => _OInstantReportScreenState();
}

class _OInstantReportScreenState extends State<OInstantReportScreen> {
  final postRef = FirebaseFirestore.instance.collection('Instant Reports')
   .where('Submit to', isEqualTo: 'Ambulance');
