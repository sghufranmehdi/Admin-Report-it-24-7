...
class PInstantReportScreen extends StatefulWidget {
  const PInstantReportScreen({Key? key}) : super(key: key);

  @override
  _PInstantReportScreenState createState() => _PInstantReportScreenState();
}

class _PInstantReportScreenState extends State<PInstantReportScreen> {
  final postRef = FirebaseFirestore.instance
      .collection('Instant Reports')
