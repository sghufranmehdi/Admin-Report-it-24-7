...
class RInstantReportScreen extends StatefulWidget {
  const RInstantReportScreen({Key? key}) : super(key: key);

  @override
  _RInstantReportScreenState createState() => _RInstantReportScreenState();
}

class _RInstantReportScreenState extends State<RInstantReportScreen> {
