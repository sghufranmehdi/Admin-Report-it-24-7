...
class RAllReportScreen extends StatefulWidget {
  const RAllReportScreen({Key? key}) : super(key: key);

  @override
  _RAllReportScreenState createState() => _RAllReportScreenState();
}

class _RAllReportScreenState extends State<RAllReportScreen> {
                                                  ...
                                                  return AlertDialog(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        DropdownButton(
                                                          hint: Text(
                                                              'Please choose '), // necessary for Option 1
                                                          value:
                                                              _selectedDepartment,
                                                          onChanged:
                                                              (newValue) {
